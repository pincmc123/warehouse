                            ...
                            <div class="col-lg-12">
                                ...
                                @csrf <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="isInput" value="1" checked>InPut
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="isInput" value="0">OutPut
                                        </label>                                      
                                    </div>     
                                    <div class="form-group">
                                        <label>Active</label>
                                        <label class="radio-inline">
                                            <input type="radio" name="type" value="NEW" checked>NEW
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="type" value="USED">USED
                                        </label>   
                                        <label class="radio-inline">
                                            <input type="radio" name="type" value="DEFECTIVE">DEFECTIVE
                                        </label>                                    
                                    </div>                                    
