                            ...
                            <div class="col-lg-12">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <label>Role</label>
                                        <label class="radio-inline">
                                            <input type="radio" name="isRole" value="SALE" checked>SALE
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="isRole" value="TECH">TECH
                                        </label>    
                                        <label class="radio-inline">
                                            <input type="radio" name="isRole" value="WAREHOUSE">WAREHOUSE
                                        </label>                                    
                                    </div>                                   
