                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>                                              
                                                ...
                                                <tr>
                                                    <td>{{$data->code}}</td>
                                                    <td>{{$data->name}}</td>
                                                    <td>@if($data->is_input == 1) InPut @else OutPut @endif</td>                                           
                                                    <td>{{$data->type}}</td>
                                                    <td>@if($data->is_active == 1) Active @else Inactive @endif</td>                                           
                                                    <td>{{$data->modify_by}}</td>
                                                    <td><a href="{{route('reasonedit',$data->id)}}">Edit</a></td>
                                                </tr>
                                                @endforeach
                                    ...
                                    <!-- /.table-responsive -->
                                    <div class="well">
                                                      <a class="btn btn-default btn-lg btn-block"  href="{{route('reasonadd')}}">ADD NEW</a>
                                    </div>
                                </div>
                                <!-- /.panel-body -->
                            </div>
