                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>  <a href="{!! route('change-language', ['en']) !!}">English</a>
                            </li>
                            <li><a href="{!! route('change-language', ['vi']) !!}">Vietnam</a>
                            </li>
                            <li class="divider"></li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-files-o fa-fw"></i>NEW<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{route('newinput')}}">INPUT</a>
                                    </li>
                                    <li>
...
@if (session('status'))
    <div class="alert alert-success position-absolute" style="position: fixed;    top: 100px;    right: 0px;   z-index: 1;">
        {{ session('status') }}
    </div>
@endif
