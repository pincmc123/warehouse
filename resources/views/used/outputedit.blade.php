            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">  
                        <form    role="form" action="{{route('newinputpostedit')}}" method="POST" autocomplete="off">
                        <div class="row">
                            <div class="col-lg-6">    
                            <input name="type" value="USED" type="hidden">     
                                <input name="arinvoice_id" value="{{$data->id}}" type="hidden">     
                                @csrf 
                                    <div class="form-group">
                                        <label>Phiếu</label>
                                        <input class="form-control"  value="{{$data->arinvoice_code}}" readonly>                                  
                                    </div>
                                    <div class="form-group">
                                ...
                                <!--      <select class="form-control" name="customer">
                                  ...
                                  <!--      <select class="form-control" name="user">
                                    ...
                                    <!--    <select class="form-control" name="reason">
                                        <option></option>
                                        @foreach (\App\Models\reason::where('is_input','=','1')->where('type','=','USED')->get() as $item)
                                        <option value="{{$item->id}}">{{$item->name}}</option>
                                         @endforeach
                                         </select>-->
                          ...
                          <!--     <div class="form-group">            
                               ...
                               <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">                                         
                                            ...
                                            @foreach(\App\Models\arinvoiceline::where('arinvoice_id','=',$data->id)->get() as $key => $seri)
