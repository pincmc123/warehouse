                            ...
                            <div class="col-lg-6">    
                                ...
                                @csrf 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option></option>
                                        @foreach (\App\Models\reason::where('is_input','=','0')->where('type','=','USED')->get() as $item)
                                        <option value="{{$item->id}}">{{$item->name}}</option>
                                         @endforeach
                                         </select>
                                    </div>
...
@foreach(\App\Models\item::where('is_active','<>','0')->get() as $item)
<datalist id="{{$item->id}}">
@foreach(\App\Models\apinvoiceline::where('item_id','=',$item->id)->where('is_open','=',1)->where('type','=','USED')->get('seri') as $seri)
